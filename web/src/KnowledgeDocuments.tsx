...
const labels: Record<string, string> = { native: "按需加载", queued: "等待整理", indexing: "正在整理", ready: "可检索", failed: "整理失败", disabled: "已停用" };
  ...
  return <div className="knowledge-documents">
    ...
    <div className="kd-layout">
      <aside className="kd-library"><nav className="kd-category-tabs" aria-label="知识形式">
        ...
        {category === "documents" && <Button variant="ghost" className="m-3 justify-start" onClick={() => openResearch("history")}>萃取任务 · 进行中与历史记录 →</Button>}
