...
export function DeliveryAnalytics() {
  ...
  return <div className="delivery-analysis">
    ...
    <section className="delivery-card"><h2>任务明细 <span>点击查看代码来源、Token 消耗与提交记录</span></h2><div className="delivery-table-scroll"><table><thead><tr><th>需求 / 任务</th><th>状态</th><th>交付代码行数</th><th>首次实现占比</th><th>Token 消耗</th><th>统计覆盖</th></tr></thead><tbody>{groupRows.slice(currentPage * 10, currentPage * 10 + 10).map(([id, tasks]) => {
